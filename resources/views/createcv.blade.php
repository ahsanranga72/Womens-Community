          ...
          <div class="bs-stepper-content">
            <div id="test-l-1" class="content">
              ...
              <div class="form-group">
                ...
                <input type="Text" class="form-control" id="Addresss" name="Addresss" placeholder="Enter Addresss">
              </div>
            ...
            <div id="test-l-2" class="content">
              <div class="form-group">
                ...
                <div class="form-group work1">
                  ...
                  <input type="Text" class="form-control" id="JobTitle1" name="JobTitle1" placeholder="Enter Job Title">
                  <label for="CompanyName1">Company Name</label>
                  <input type="Text" class="form-control" id="CompanyName1" name="CompanyName1" placeholder="Enter Company Name">
                  <label for="Duration1">Duration</label>
                  <input type="Text" class="form-control" id="Duration1" name="Duration1" placeholder="Enter Duration">
                ...
                <div class="form-group work2">
                  ...
                  <label for="JobTitle1">Job Title</label>
                  <input type="Text" class="form-control" id="JobTitle2" name="JobTitle2" placeholder="Enter Job Title">
                  <label for="CompanyName1">Company Name</label>
                  <input type="Text" class="form-control" id="CompanyName2" name="CompanyName2" placeholder="Enter Company Name">
                  <label for="Duration2">Duration</label>
                  <input type="Text" class="form-control" id="Duration2" name="Duration2" placeholder="Enter Duration">
                ...
                <div class="form-group work3">
                  ...
                  <label for="JobTitle1">Job Title</label>
                  <input type="Text" class="form-control" id="JobTitle3" name="JobTitle3" placeholder="Enter Job Title">
                  <label for="CompanyName1">Company Name</label>
                  <input type="Text" class="form-control" id="CompanyName3" name="CompanyName3" placeholder="Enter Company Name">
                  <label for="Duration3">Duration</label>
                  <input type="Text" class="form-control" id="Duration3" name="Duration3" placeholder="Enter Duration">
                  <label for="Description3">Description</label>
                  <input type="Text" class="form-control" id="Description3" name="Description3" placeholder="Enter Description">
                </div>
                ...
                <div class="form-group work4">
                  ...
                  <label for="JobTitle1">Job Title</label>
                  <input type="Text" class="form-control" id="JobTitle4" name="JobTitle4" placeholder="Enter Job Title">
                  <label for="CompanyName1">Company Name</label>
                  <input type="Text" class="form-control" id="CompanyName4" name="CompanyName4" placeholder="Enter Company Name">
                  <label for="Duration4">Duration</label>
                  <input type="Text" class="form-control" id="Duration4" name="Duration4" placeholder="Enter Duration">
                  <label for="Description4">Description</label>
                  <input type="Text" class="form-control" id="Description4" name="Description4" placeholder="Enter Description">
                </div>
                ...
                <div class="form-group work5">
                  ...
                  <label for="JobTitle1">Job Title</label>
                  <input type="Text" class="form-control" id="JobTitle5" name="JobTitle5" placeholder="Enter Job Title">
                  <label for="CompanyName1">Company Name</label>
                  <input type="Text" class="form-control" id="CompanyName5" name="CompanyName5" placeholder="Enter Company Name">
                  <label for="Duration5">Duration</label>
                  <input type="Text" class="form-control" id="Duration5" name="Duration5" placeholder="Enter Duration">
                  <label for="Description5">Description</label>
                  <input type="Text" class="form-control" id="Description5" name="Description5" placeholder="Enter Description">
                </div>
                ...
                <div class="form-group Education1">
                  ...
                  <input type="Text" class="form-control" id="ExamName1" name="ExamName1" placeholder="Enter Exam Name">
                  <label for="InstitutionName1">Institution Name</label>
                  <input type="Text" class="form-control" id="InstitutionName1" name="InstitutionName1" placeholder="Enter Institution Name">
                  ...
                  <input type="Text" class="form-control" id="Grade1" name="Grade1" placeholder="Enter Grade">
                  <label for="PassingYear1">Passing Year</label>
                  <input type="Number" class="form-control" id="PassingYear1" name="PassingYear1" placeholder="Enter Passing Year">
                </div>
                ...
                <div class="form-group Education2">
                  ...
                  <input type="Text" class="form-control" id="ExamName2" name="ExamName2" placeholder="Enter Exam Name">
                  <label for="InstitutionName2">Institution Name</label>
                  <input type="Text" class="form-control" id="InstitutionName2" name="InstitutionName2" placeholder="Enter Institution Name">
                  ...
                  <input type="Text" class="form-control" id="Grade2" name="Grade2" placeholder="Enter Grade">
                  <label for="PassingYear2">Passing Year</label>
                  <input type="Number" class="form-control" id="PassingYear2" name="PassingYear2" placeholder="Enter Passing Year">
                </div>
                ...
                <div class="form-group Education3">
                  ...
                  <input type="Text" class="form-control" id="ExamName3" name="ExamName3" placeholder="Enter Exam Name">
                  <label for="InstitutionName3">Institution Name</label>
                  <input type="Text" class="form-control" id="InstitutionName3" name="InstitutionName3" placeholder="Enter Institution Name">
                  ...
                  <input type="Text" class="form-control" id="Grade3" name="Grade3" placeholder="Enter Grade out of">
                  <label for="PassingYear3">Passing Year</label>
                  <input type="Number" class="form-control" id="PassingYear3" name="PassingYear3" placeholder="Enter Passing Year">
                </div>
                ...
                <div class="form-group Education4">
                  ...
                  <input type="Text" class="form-control" id="ExamName4" name="ExamName4" placeholder="Enter Exam Name">
                  <label for="InstitutionName4">Institution Name</label>
                  <input type="Text" class="form-control" id="InstitutionName4" name="InstitutionName4" placeholder="Enter Institution Name">
                  ...
                  <input type="Text" class="form-control" id="Grade4" name="Grade4" placeholder="Enter Grade out of">
                  <label for="PassingYear4">Passing Year</label>
                  <input type="Number" class="form-control" id="PassingYear4" name="PassingYear4" placeholder="Enter Passing Year">
                </div>
                ...
                <div class="form-group Education5">
                  ...
                  <input type="Text" class="form-control" id="ExamName5" name="ExamName5" placeholder="Enter Exam Name">
                  <label for="InstitutionName5">Institution Name</label>
                  <input type="Text" class="form-control" id="InstitutionName5" name="InstitutionName5" placeholder="Enter Institution Name">
                  ...
                  <input type="Text" class="form-control" id="Grade5" name="Grade5" placeholder="Enter Grade out of">
                  <label for="PassingYear5">Passing Year</label>
                  <input type="Number" class="form-control" id="PassingYear5" name="PassingYear5" placeholder="Enter Passing Year">
                </div>
            ...
            <div id="test-l-3" class="content">
              <div class="form-group">
                ...
                <div class="row">
                  <div class="form-group col-md-6">
                    <input type="text" class="form-control" id="Skill1" name="Skill1" placeholder="Enter Skill name">
                  </div>
                  <div class="form-group col-md-6">
                ...
                <div class="row">
                  <div class="form-group col-md-6">
                    <input type="text" class="form-control" id="Skill2" name="Skill2" placeholder="Enter Skill name">
                  </div>
                  <div class="form-group col-md-6">
                ...
                <div class="row">
                  <div class="form-group col-md-6">
                    <input type="text" class="form-control" id="Skill3" name="Skill3" placeholder="Enter Skill name">
                  </div>
                  <div class="form-group col-md-6">
                ...
                <div class="row">
                  <div class="form-group col-md-6">
                    <input type="text" class="form-control" id="Skill4" name="Skill4" placeholder="Enter Skill name">
                  </div>
                  <div class="form-group col-md-6">
                ...
                <div class="row">
                  <div class="form-group col-md-6">
                    <input type="text" class="form-control" id="Ln1" name="Ln1" placeholder="Enter Language name">
                  </div>
                  <div class="form-group col-md-6">
                ...
                <div class="row">
                  <div class="form-group col-md-6">
                    <input type="text" class="form-control" id="Ln2" name="Ln2" placeholder="Enter Language name">
                  </div>
                  <div class="form-group col-md-6">
                ...
                <div class="row">
                  <div class="form-group col-md-6">
                    <input type="text" class="form-control" id="Ln3" name="Ln3" placeholder="Enter Language name">
                  </div>
                  <div class="form-group col-md-6">
                ...
                <textarea class="form-control" id="ExtraCurriculamActivities" name="ExtraCurriculamActivities" placeholder="Enter Extra Curriculam Activities" cols="30" rows="3"></textarea>
                <label for="References">References</label>
                <textarea class="form-control" id="References" name="References" placeholder="Enter References" cols="30" rows="3"></textarea>
              </div>
              <button class="btn btn-primary" type="button" onclick="stepper1.previous()">Previous</button>
